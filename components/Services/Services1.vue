      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
          <div class="sec-head text-center">
            <h6 class="wow fadeIn" data-wow-delay=".5s">Brand velocity, growth models reimagined.</h6>
            <h3 class="wow color-font">
              Bandkandy crafts fan-first experiences that unleash brand affinity at launch and beyond.
            </h3>
          </div>
        </div>
      </div>
