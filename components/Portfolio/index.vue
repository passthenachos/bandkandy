<template>
  <section class="portfolio section-padding pb-70">
    ...
    <div :class="`${grid == 3 ? 'container-fluid' : 'container'}`">
      <div class="row">
        <div :class="`filtering ${filterPosition === 'center'
          ? 'text-center'
          : filterPosition === 'left'
            ? 'text-left'
            : 'text-right'
        ...
        <div class="gallery full-width">
          <div :class="`${grid == 3
            ...
            <div class="cont">
              ...
              <span>
                <NuxtLink to="#0">Design</NuxtLink>,
                <NuxtLink to="#0">WordPress</NuxtLink>
              </span>
            </div>
          </div>
          ...
          <div :class="`${grid == 3
            ...
            <div class="cont">
              ...
              <span>
                <NuxtLink to="#">Design</NuxtLink>,
                <NuxtLink to="#">WordPress</NuxtLink>
              </span>
            </div>
          </div>
...
const { grid, filterPosition } = defineProps(['grid', 'filterPosition']);
