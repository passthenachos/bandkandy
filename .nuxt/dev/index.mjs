globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mulch/Documents/GitHub/bandkandy/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/mulch/Documents/GitHub/bandkandy/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mulch/Documents/GitHub/bandkandy","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mulch/Documents/GitHub/bandkandy/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mulch/Documents/GitHub/bandkandy/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mulch/Documents/GitHub/bandkandy/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mulch/Documents/GitHub/bandkandy/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_wPJeXR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_wPJeXR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wPJeXR, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"keywords","name":"keywords","content":"Nuxt3 Vue Template vie onepage themeforest"},{"hid":"description","name":"description","content":"vie - Onepage Multi-Purpose Vue Nuxt3 Template"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Montserrat+Alternates:wght@100;200;300;400;500;600;700;800;900&display=swap"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Manrope:wght@200;300;400;500;600;700;800&display=swap"}],"style":[],"script":[{"src":"/js/wow.min.js"},{"src":"/js/isotope.pkgd.min.js"},{"src":"/js/pace.min.js"},{"src":"/js/splitting.min.js"},{"src":"/js/simpleParallax.min.js"}],"noscript":[],"title":"BandKandy","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/mulch/Documents/GitHub/bandkandy/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/mulch/Documents/GitHub/bandkandy/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
